...
<div class="page_main_div">
    <nav class="arplite_growth_top">
        <a class="nav_logo" href="<?php echo admin_url( 'admin.php?page=arpricelite' ); ?>">
            <img class="arplite_growth_top_logo" src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/arprice-top-logo.png' ?>">
        </a>
        ...
        <div class="arplite_growth_bottom_first_content">
            ...
            <div class="arplite_growth_bottom_first_content_premium">
                <div class="arplite_growth_bottom_first_content_premium_inner">
                    <div class="content1">
                        <img class="content1_img" src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/cs-lifetime-update.png' ?>">
                    </div>
                    <div class="content2">
                    ...
                    <div class="content3">
                        <img class="content2_img" src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/cs-lifetime-page-builder.png' ?>">
                    </div>
                    <div class="content4">
            ...
            <div class="arplite_pro_upgrade_button_wrapper">
                <a href="<?php echo 'https://www.arpriceplugin.com/premium/upgrade_to_premium.php?rdt=t1&arp_version=' . $arpricelite_version . '&arp_request_version=' . get_bloginfo( 'version' ); ?>" target="_blank" class="upgrade_button">Upgrade to Premium</a>
            </div>

            <img class="page_break_img" src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/cs-lifetime-section-divider.png' ?>">

            <div class="plugin_details_main">
                <div class="plugin_details_main_heading">
                        <img src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/cs-lifetime-family-plugin-star.png' ?>">
                ...
                <div class="plugin_cards">
                        ...
                        <!-- booking press card -->
                        <div class="card1">
                            <div class="logo"> <img src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/bookingpress-logo.png' ?>"></div>
                            <div class="content">
                                ...
                                <div class="card_last_section">
                                        ...
                                        <label class="second_a">
                                            <input type="hidden" name="arp_install_booking_press_nonce" id="arp_install_booking_press_nonce" value="<?php echo wp_create_nonce("arp_install_booking_press_nonce") ?>">
                                            <?php 
                                                ...
                                                {
                                                    ?> <button class="arp_install_booking_press" id="install_bookingpress">Install</button> <?php
                                                }
                                            ?>
                                        </label>             
                    ...
                    <!-- armember card -->
                    <div class="card1">
                            <div class="logo"> <img src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/armember-logo.png' ?>"></div>
                            <div class="content">
                                <div class="card_heading">
                                ...
                                <div class="card_last_section">
                                        ...
                                        <label class="second_button">
                                            <input type="hidden" name="arp_install_armember_nonce" id="arp_install_armember_nonce" value="<?php echo wp_create_nonce("arp_install_armember_nonce") ?>">
                                            <?php
                                                ...
                                                {
                                            ?>
                                            <button class="arp_install_armember" id="install_armember">Install</button> 
                                            <?php }?>
                                        </label>      
                        ...
                        <!-- arprice card -->
                        <div class="card1">
                            <div class="logo"> <img src="<?php echo ARPLITE_PRICINGTABLE_IMAGES_URL . '/arforms-logo.png' ?>"></div>
                            <div class="content">
                                <div class="card_heading">
                                ...
                                <div class="card_last_section">
                                    <a href="https://wordpress.org/plugins/arforms-form-builder/" target="_blank" class="learn_more_arforms">Learn More</a>
                                        <input type="hidden" name="arp_install_arforms_nonce" id="arp_install_arforms_nonce" value="<?php echo wp_create_nonce('arp_install_arforms_nonce'); ?>">
                                        <label class="second_button">
                                            <?php
                                                ...
                                                {
                                            ?>
                                            <button class="arp_install_arforms" id="install_arforms">Install</button> 
                                            <?php  } ?>
                                        </label>    
