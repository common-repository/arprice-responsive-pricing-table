...
$wpdb->query( 'CREATE TABLE `' . $arplite_price_backup_tbl . '` LIKE `' . $wpdb->prefix . 'arplite_arprice`' ); //phpcs:ignore
$wpdb->query( 'INSERT `' . $arplite_price_backup_tbl . '` SELECT * FROM `' . $wpdb->prefix . 'arplite_arprice`' ); //phpcs:ignore

$wpdb->query( 'CREATE TABLE `' . $arplite_price_options_backup_tbl . '` LIKE `' . $wpdb->prefix . 'arplite_arprice_options`' ); //phpcs:ignore
$wpdb->query( 'INSERT `' . $arplite_price_options_backup_tbl . '` SELECT * FROM `' . $wpdb->prefix . 'arplite_arprice_options`' ); //phpcs:ignore
